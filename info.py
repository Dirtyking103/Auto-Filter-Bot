...
# Bot information
API_ID = environ.get('API_ID', '22213072')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '7202892465')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002233069580 -1002203224103').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002244630898')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002218034046')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://dirtyking102:KLT5HXFTfou4QieE@dirtyking.gdvsj.mongodb.net/?retryWrites=true&w=majority&appName=Dirtyking")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002165162202")
